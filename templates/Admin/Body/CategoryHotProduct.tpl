	...
	<div class="box">
		...
		<div class="table">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				{foreach from=$new_product item=elem}
				<tr class="{cycle values="odd,even"}">					
					...
					<td><a href="/admin.php?act=Show&class=CategoryHot&parent_id={$smarty.get.parent_id}&id_product={$elem.ID}#addForm" class="ico edit">Edit</a></td>
				</tr>
				{/foreach}				
			</table>	
			<!-- Pagging -->
